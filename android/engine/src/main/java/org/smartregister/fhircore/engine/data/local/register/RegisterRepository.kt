...
constructor(
  ...
  fun retrieveOtherReportConfiguration(reportId: String): OtherReportConfiguration =
    configurationRegistry.retrieveConfiguration<OtherReportConfiguration>(
  ...
  suspend fun updateNotificationStatus(resourceId: String) {
    withContext(dispatcherProvider.io()) {
      fhirEngine.get(ResourceType.MessageDefinition, resourceId).apply {
        (this as MessageDefinition).status = Enumerations.PublicationStatus.UNKNOWN
        update(this)
      }
    }
  }
